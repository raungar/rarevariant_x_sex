...
sent_data<-NormalizeData(sent_data)
...
red_data<-subset(red_data,idents="CD8 T cell")
...
write.table(data.frame(preds_all),"/oak/stanford/groups/smontgom/raungar/Sex/Output/analysis_v8/continuous/SingleCell/preds_test.txt")
...
write.table(coefs,file="/oak/stanford/groups/smontgom/raungar/Sex/Output/analysis_v8/continuous/SingleCell/coefs.txt",sep="\t",row.names=T,col.names=T, quote=FALSE)

preds_test<-fread("/oak/stanford/groups/smontgom/raungar/Sex/Output/analysis_v8/continuous/SingleCell/preds_test.txt")
