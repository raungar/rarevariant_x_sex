...
filename = "/oak/stanford/groups/smontgom/shared/UDN/ReferenceFiles/CADDv1.6/data/prescored/GRCh38_v1.6/no_anno/whole_genome_SNVs.tsv.gz"
#print(filename)
...
for line in sys.stdin:
  ...
  if not raw:
    sys.stdout.write("\t".join(fields + ['NA','NA']) + '\n')
  else:
