...
=======
   #infile="/Volumes/groups/smontgom/raungar/Sex/Output/sexdeg_v8/Outliers/Current/outliersTOP_noglobal_medz_zthresh2.5_nphen3_x_f_beta0.111.txt.gz"
   # this_variant_file="/Volumes/groups/smontgom/raungar/Sex/Output/features_v8/Collapsed/collapsed_x_CADDtypesGQ5BlacklistRemovedALL_cadd15.txt.gz"
#  method="medz"
 #  this_chr="chrX"
...
=======
  #infile="/Volumes/groups/smontgom/raungar/Sex/Output/outliers_v8/Current/outliers_noglobal_medz_zthresh2_nphen3_aut_both.txt.gz"
  medz_outliers = fread(infile)
>>>>>>> 202c5a6ea887360d6e510761cb21611ce0d6089e
...
variant_file = fread(this_variant_file,header=F,fill=TRUE)
print("ORIGINAL...")
colnames(variant_file)<-c("chr","start","end","ensg","vartype","ind","sex","gtex_maf","gnomad_maf","use_maf","genetype","cadd_raw","cadd_phred","geno","numrv")
>>>>>>> 202c5a6ea887360d6e510761cb21611ce0d6089e
print(head(variant_file))
