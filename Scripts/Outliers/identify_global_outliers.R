...
option_list = list(
		make_option(c('--OUTLIERS'), type = 'character', default = NULL, help = 'path to the Z-score data'),
		make_option(c("--outfile"), type = 'character', default = NULL, help = "path of output file"),
...
write.table(medz_data, file=outfile, sep='\t', quote=F, row.names=F)
print("done")
